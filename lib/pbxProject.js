...
pbxProject.prototype.enablePushNotifcations = function (enable) {
    var pushEnabled = 0;
    ...
    var buildPhaseTargetUuid = this.getFirstTarget().uuid
    this.pbxProjectSection()[this.getFirstProject()['uuid']]['attributes']['TargetAttributes'][buildPhaseTargetUuid]['SystemCapabilities']['com.apple.Push'].enabled = pushEnabled;
}

pbxProject.prototype.updateTeamID = function (teamID) {
    var buildPhaseTargetUuid = this.getFirstTarget().uuid
    this.pbxProjectSection()[this.getFirstProject()['uuid']]['attributes']['TargetAttributes'][buildPhaseTargetUuid]['DevelopmentTeam'] = teamID;
}
